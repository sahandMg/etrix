...
class CreateConnectorsInterconnectsCircularConnectorsContactsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(18)->helper);
        Schema::create('connectors__interconnects__circular__connectors__contacts', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('connectors__interconnects__circular__connectors__contacts');
    }
}
