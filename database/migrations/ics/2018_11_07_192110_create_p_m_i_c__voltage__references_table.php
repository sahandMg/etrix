...
class CreatePMICVoltageReferencesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                                $this->cols = unserialize(\App\Helper::find(161)->helper);
        Schema::create('p_m_i_c__voltage__references', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('p_m_i_c__voltage__references');
    }
}
