...
class CreateClockTimingICBatteriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(77)->helper);
        Schema::create('clock__timing__i_c__batteries', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('clock__timing__i_c__batteries');
    }
}
