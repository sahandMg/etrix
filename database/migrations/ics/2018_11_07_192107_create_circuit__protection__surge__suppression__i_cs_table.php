...
class CreateCircuitProtectionSurgeSuppressionICsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(13)->helper);
        Schema::create('circuit__protection__surge__suppression__i_cs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('circuit__protection__surge__suppression__i_cs');
    }
}
