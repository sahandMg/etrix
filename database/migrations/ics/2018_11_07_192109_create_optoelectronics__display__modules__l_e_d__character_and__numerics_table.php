...
class CreateOptoelectronicsDisplayModulesLEDCharacterAndNumericsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
               $this->cols = unserialize(\App\Helper::find(178)->helper);
        Schema::create('modules__l_e_d__character_and__numerics', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('modules__l_e_d__character_and__numerics');
    }
}
