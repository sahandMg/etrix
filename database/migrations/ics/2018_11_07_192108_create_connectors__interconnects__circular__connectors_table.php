...
class CreateConnectorsInterconnectsCircularConnectorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(17)->helper);
        Schema::create('connectors__interconnects__circular__connectors', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('connectors__interconnects__circular__connectors');
    }
}
