...
class CreateClockTimingDelayLinesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(76)->helper);
        Schema::create('clock__timing__delay__lines', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('clock__timing__delay__lines');
    }
}
