...
class CreateHardwareFastenersAccessoriesBoardSupportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('hardware__fasteners__accessories__board__supports', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('hardware__fasteners__accessories__board__supports');
    }
}
