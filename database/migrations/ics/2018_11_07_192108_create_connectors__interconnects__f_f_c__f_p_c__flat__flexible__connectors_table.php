...
class CreateConnectorsInterconnectsFFCFPCFlatFlexibleConnectorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(20)->helper);
        Schema::create('ffc__fpc__flat__flexible__connectors', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('ffc__fpc__flat__flexible__connectors');
    }
}
