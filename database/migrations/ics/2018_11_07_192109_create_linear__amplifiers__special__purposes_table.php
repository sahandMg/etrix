...
class CreateLinearAmplifiersSpecialPurposesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
          $this->cols = unserialize(\App\Helper::find(115)->helper);
        Schema::create('linear__amplifiers__special__purposes', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('linear__amplifiers__special__purposes');
    }
}
