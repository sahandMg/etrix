...
class CreateRectangularConnectorsBoardSpacersStackersBoardToBoardsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                                   $this->cols = unserialize(\App\Helper::find(23)->helper);
        Schema::create('spacers__stackers__board_to__boards', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('spacers__stackers__board_to__boards');
    }
}
