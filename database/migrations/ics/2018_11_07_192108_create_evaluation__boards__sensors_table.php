...
class CreateEvaluationBoardsSensorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
              $this->cols = unserialize(\App\Helper::find(37)->helper);
        Schema::create('evaluation__boards__sensors', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('evaluation__boards__sensors');
    }
}
