...
class CreateCapacitorsTantalumPolymerCapacitorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(240)->helper);
        Schema::create('capacitors__tantalum__polymer__capacitors', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('capacitors__tantalum__polymer__capacitors');
    }
}
