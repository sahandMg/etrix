...
class CreateCablesWiresManagementMarkersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(7)->helper);
        Schema::create('cables__wires__management__markers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('cables__wires__management__markers');
    }
}
