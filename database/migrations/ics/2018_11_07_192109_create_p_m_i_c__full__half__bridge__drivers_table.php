...
class CreatePMICFullHalfBridgeDriversTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                  $this->cols = unserialize(\App\Helper::find(144)->helper);
        Schema::create('p_m_i_c__full__half__bridge__drivers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('p_m_i_c__full__half__bridge__drivers');
    }
}
