...
class CreateLogicSignalSwitchesMultiplexersDecodersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                                  $this->cols = unserialize(\App\Helper::find(131)->helper);
        Schema::create('logic__signal__switches__multiplexers__decoders', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('logic__signal__switches__multiplexers__decoders');
    }
}
