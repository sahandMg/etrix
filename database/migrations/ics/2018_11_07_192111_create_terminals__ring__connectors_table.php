...
class CreateTerminalsRingConnectorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                      $this->cols = unserialize(\App\Helper::find(31)->helper);
        Schema::create('terminals__ring__connectors', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('terminals__ring__connectors');
    }
}
