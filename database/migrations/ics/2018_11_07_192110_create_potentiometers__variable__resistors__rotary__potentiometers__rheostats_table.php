...
class CreatePotentiometersVariableResistorsRotaryPotentiometersRheostatsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
          $this->cols = unserialize(\App\Helper::find(181)->helper);
        Schema::create('rotary__potentiometers__rheostats', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('rotary__potentiometers__rheostats');
    }
}
