...
class CreateDataAcquisitionAnalogFrontEndAFEsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
          $this->cols = unserialize(\App\Helper::find(81)->helper);
        Schema::create('data__acquisition__analog__front__end__a_f_es', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('data__acquisition__analog__front__end__a_f_es');
    }
}
