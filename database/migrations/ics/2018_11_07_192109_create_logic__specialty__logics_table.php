...
class CreateLogicSpecialtyLogicsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                                  $this->cols = unserialize(\App\Helper::find(132)->helper);
        Schema::create('logic__specialty__logics', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('logic__specialty__logics');
    }
}
