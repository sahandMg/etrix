...
class CreatePotentiometersVariableResistorsTrimmerPotentiometersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
              $this->cols = unserialize(\App\Helper::find(182)->helper);
        Schema::create('resistors__trimmer__potentiometers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('resistors__trimmer__potentiometers');
    }
}
