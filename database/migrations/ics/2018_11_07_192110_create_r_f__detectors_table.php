...
class CreateRFDetectorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                        $this->cols = unserialize(\App\Helper::find(189)->helper);
        Schema::create('r_f__detectors', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('r_f__detectors');
    }
}
