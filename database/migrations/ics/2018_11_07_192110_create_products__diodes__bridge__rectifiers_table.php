...
class CreateProductsDiodesBridgeRectifiersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                        $this->cols = unserialize(\App\Helper::find(39)->helper);
        Schema::create('products__diodes__bridge__rectifiers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('products__diodes__bridge__rectifiers');
    }
}
