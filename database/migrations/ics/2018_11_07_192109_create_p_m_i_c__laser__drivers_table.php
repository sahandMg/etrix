...
class CreatePMICLaserDriversTable extends Migration
{
    ...
    public function up()
    {
                              $this->cols = unserialize(\App\Helper::find(147)->helper);
        Schema::create('p_m_i_c__laser__drivers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('p_m_i_c__laser__drivers');
    }
}
