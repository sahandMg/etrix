...
class CreateRFIFAndRFIDBalunsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                                 $this->cols = unserialize(\App\Helper::find(186)->helper);
        Schema::create('r_f__i_f_and__r_f_i_d__baluns', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('r_f__i_f_and__r_f_i_d__baluns');
    }
}
