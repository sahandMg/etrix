...
class CreateCapacitorsAccessoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(232)->helper);
        Schema::create('capacitors__accessories', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('capacitors__accessories');
    }
}
