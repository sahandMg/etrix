...
class CreateResistorsThroughHoleResistorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                     $this->cols = unserialize(\App\Helper::find(206)->helper);
        Schema::create('resistors__through__hole__resistors', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('resistors__through__hole__resistors');
    }
}
