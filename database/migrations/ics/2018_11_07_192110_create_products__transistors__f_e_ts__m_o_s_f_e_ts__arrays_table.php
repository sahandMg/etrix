...
class CreateProductsTransistorsFETsMOSFETsArraysTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                  $this->cols = unserialize(\App\Helper::find(56)->helper);
        Schema::create('products__transistors__f_e_ts__m_o_s_f_e_ts__arrays', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('products__transistors__f_e_ts__m_o_s_f_e_ts__arrays');
    }
}
