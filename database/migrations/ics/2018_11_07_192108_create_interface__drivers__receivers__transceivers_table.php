...
class CreateInterfaceDriversReceiversTransceiversTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
            $this->cols = unserialize(\App\Helper::find(99)->helper);
        Schema::create('interface__drivers__receivers__transceivers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('interface__drivers__receivers__transceivers');
    }
}
