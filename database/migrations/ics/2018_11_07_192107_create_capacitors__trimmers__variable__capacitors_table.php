...
class CreateCapacitorsTrimmersVariableCapacitorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(11)->helper);
        Schema::create('capacitors__trimmers__variable__capacitors', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('capacitors__trimmers__variable__capacitors');
    }
}
