...
class CreateProductsTransistorsSpecialPurposesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                     $this->cols = unserialize(\App\Helper::find(63)->helper);
        Schema::create('products__transistors__special__purposes', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('products__transistors__special__purposes');
    }
}
