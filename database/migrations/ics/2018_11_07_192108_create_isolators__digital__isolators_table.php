...
class CreateIsolatorsDigitalIsolatorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                $this->cols = unserialize(\App\Helper::find(169)->helper);
        Schema::create('isolators__digital__isolators', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('isolators__digital__isolators');
    }
}
