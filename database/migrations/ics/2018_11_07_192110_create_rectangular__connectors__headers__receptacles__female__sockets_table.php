...
class CreateRectangularConnectorsHeadersReceptaclesFemaleSocketsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                                         $this->cols = unserialize(\App\Helper::find(25)->helper);
        Schema::create('headers__receptacles__female__sockets', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('headers__receptacles__female__sockets');
    }
}
