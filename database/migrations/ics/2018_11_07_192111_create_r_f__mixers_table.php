...
class CreateRFMixersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                                         $this->cols = unserialize(\App\Helper::find(192)->helper);
        Schema::create('r_f__mixers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('r_f__mixers');
    }
}
