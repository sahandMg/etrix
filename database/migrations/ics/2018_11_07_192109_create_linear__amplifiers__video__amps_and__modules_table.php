...
class CreateLinearAmplifiersVideoAmpsAndModulesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
              $this->cols = unserialize(\App\Helper::find(116)->helper);
        Schema::create('linear__amplifiers__video__amps_and__modules', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('linear__amplifiers__video__amps_and__modules');
    }
}
