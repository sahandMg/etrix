...
class CreateEmbeddedMicrocontrollersApplicationSpecificsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                   $this->cols = unserialize(\App\Helper::find(90)->helper);
        Schema::create('embedded__microcontrollers__application__specifics', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('embedded__microcontrollers__application__specifics');
    }
}
