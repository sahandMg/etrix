...
class CreateEmbeddedCPLDsComplexProgrammableLogicDevicesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(86)->helper);
        Schema::create('embedded__c_p_l_ds__complex__programmable__logic__devices', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('embedded__c_p_l_ds__complex__programmable__logic__devices');
    }
}
