...
class CreateInterfaceCODECsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
       $this->cols = unserialize(\App\Helper::find(96)->helper);
        Schema::create('interface__c_o_d_e_cs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('interface__c_o_d_e_cs');
    }
}
