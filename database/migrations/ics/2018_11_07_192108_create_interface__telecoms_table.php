...
class CreateInterfaceTelecomsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
           $this->cols = unserialize(\App\Helper::find(110)->helper);
        Schema::create('interface__telecoms', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('interface__telecoms');
    }
}
