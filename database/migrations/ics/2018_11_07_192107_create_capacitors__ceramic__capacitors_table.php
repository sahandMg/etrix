...
class CreateCapacitorsCeramicCapacitorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('capacitors__ceramic__capacitors', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('capacitors__ceramic__capacitors');
    }
}
