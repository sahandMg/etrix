...
class CreateLogicLatchesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                         $this->cols = unserialize(\App\Helper::find(127)->helper);
        Schema::create('logic__latches', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('logic__latches');
    }
}
