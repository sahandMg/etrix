...
class CreateResistorsChipResistorSurfaceMountsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
             $this->cols = unserialize(\App\Helper::find(204)->helper);
        Schema::create('resistors__chip__resistor__surface__mounts', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('resistors__chip__resistor__surface__mounts');
    }
}
