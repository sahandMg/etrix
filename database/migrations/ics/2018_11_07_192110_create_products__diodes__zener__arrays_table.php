...
class CreateProductsDiodesZenerArraysTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
      $this->cols = unserialize(\App\Helper::find(44)->helper);
        Schema::create('products__diodes__zener__arrays', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('products__diodes__zener__arrays');
    }
}
