...
class CreateOpticalSensorsOpticalSensorsPhotodiodesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                             $this->cols = unserialize(\App\Helper::find(210)->helper);
        Schema::create('optical__sensors__optical__sensors__photodiodes', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('optical__sensors__optical__sensors__photodiodes');
    }
}
