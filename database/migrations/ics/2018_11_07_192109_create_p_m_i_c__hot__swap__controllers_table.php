...
class CreatePMICHotSwapControllersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                          $this->cols = unserialize(\App\Helper::find(146)->helper);
        Schema::create('p_m_i_c__hot__swap__controllers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('p_m_i_c__hot__swap__controllers');
    }
}
