...
class CreateRFAmplifiersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                      $this->cols = unserialize(\App\Helper::find(187)->helper);
        Schema::create('r_f__amplifiers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('r_f__amplifiers');
    }
}
