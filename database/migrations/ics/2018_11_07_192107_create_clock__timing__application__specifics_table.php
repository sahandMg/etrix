...
class CreateClockTimingApplicationSpecificsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(73)->helper);
        Schema::create('clock__timing__application__specifics', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('clock__timing__application__specifics');
    }
}
