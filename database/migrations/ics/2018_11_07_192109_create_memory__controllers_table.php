...
class CreateMemoryControllersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                  $this->cols = unserialize(\App\Helper::find(137)->helper);
        Schema::create('memory__controllers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('memory__controllers');
    }
}
