...
class CreateCablesWiresManagementCableTiesHoldersAndMountingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('cables__wires__management__cable__ties__holders_and__mountings', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('cables__wires__management__cable__ties__holders_and__mountings');
    }
}
