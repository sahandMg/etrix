...
class CreateTestAndMeasurementEquipmentElectricalTestersCurrentProbesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                              $this->cols = unserialize(\App\Helper::find(223)->helper);
        Schema::create('electrical__testers__current__probes', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('electrical__testers__current__probes');
    }
}
