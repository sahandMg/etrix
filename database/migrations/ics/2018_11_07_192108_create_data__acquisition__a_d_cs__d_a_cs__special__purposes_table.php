...
class CreateDataAcquisitionADCsDACsSpecialPurposesTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('data__acquisition__a_d_cs__d_a_cs__special__purposes', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('data__acquisition__a_d_cs__d_a_cs__special__purposes');
    }
}
