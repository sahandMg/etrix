...
class CreateLogicMultivibratorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                           $this->cols = unserialize(\App\Helper::find(128)->helper);
        Schema::create('logic__multivibrators', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('logic__multivibrators');
    }
}
