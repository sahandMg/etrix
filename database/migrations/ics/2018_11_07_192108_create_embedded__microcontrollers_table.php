...
class CreateEmbeddedMicrocontrollersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                      $this->cols = unserialize(\App\Helper::find(89)->helper);
        Schema::create('embedded__microcontrollers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('embedded__microcontrollers');
    }
}
