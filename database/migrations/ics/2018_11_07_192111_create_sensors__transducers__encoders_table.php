...
class CreateSensorsTransducersEncodersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                             $this->cols = unserialize(\App\Helper::find(208)->helper);
        Schema::create('sensors__transducers__encoders', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('sensors__transducers__encoders');
    }
}
