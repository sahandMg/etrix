...
class CreateDataAcquisitionTouchScreenControllersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
       $this->cols = unserialize(\App\Helper::find(85)->helper);
        Schema::create('data__acquisition__touch__screen__controllers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('data__acquisition__touch__screen__controllers');
    }
}
