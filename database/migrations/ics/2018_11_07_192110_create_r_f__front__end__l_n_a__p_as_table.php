...
class CreateRFFrontEndLNAPAsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                            $this->cols = unserialize(\App\Helper::find(200)->helper);
        Schema::create('r_f__front__end__l_n_a__p_as', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('r_f__front__end__l_n_a__p_as');
    }
}
