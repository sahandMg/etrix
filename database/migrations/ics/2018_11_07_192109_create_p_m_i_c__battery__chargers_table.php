...
class CreatePMICBatteryChargersTable extends Migration
{
    ...
    public function up()
    {
      $this->cols = unserialize(\App\Helper::find(139)->helper);
        Schema::create('p_m_i_c__battery__chargers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('p_m_i_c__battery__chargers');
    }
}
