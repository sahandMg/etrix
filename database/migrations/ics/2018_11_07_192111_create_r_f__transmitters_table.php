...
class CreateRFTransmittersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                        $this->cols = unserialize(\App\Helper::find(199)->helper);
        Schema::create('r_f__transmitters', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('r_f__transmitters');
    }
}
