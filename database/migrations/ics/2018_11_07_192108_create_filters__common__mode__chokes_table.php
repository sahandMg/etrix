...
class CreateFiltersCommonModeChokesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
           $this->cols = unserialize(\App\Helper::find(65)->helper);
        Schema::create('filters__common__mode__chokes', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('filters__common__mode__chokes');
    }
}
