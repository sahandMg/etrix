...
class CreateRFIFAndRFIDAttenuatorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                           $this->cols = unserialize(\App\Helper::find(185)->helper);
        Schema::create('r_f__i_f_and__r_f_i_d__attenuators', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('r_f__i_f_and__r_f_i_d__attenuators');
    }
}
