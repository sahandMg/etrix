...
class CreateSensorsTransducersSpecializedSensorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                                         $this->cols = unserialize(\App\Helper::find(217)->helper);
        Schema::create('sensors__transducers__specialized__sensors', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('sensors__transducers__specialized__sensors');
    }
}
