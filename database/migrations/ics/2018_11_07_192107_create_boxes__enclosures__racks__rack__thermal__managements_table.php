...
class CreateBoxesEnclosuresRacksRackThermalManagementsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(2)->helper);
        Schema::create('boxes__enclosures__racks__rack__thermal__managements', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('boxes__enclosures__racks__rack__thermal__managements');
    }
}
