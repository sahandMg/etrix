...
class CreateDevelopmentBoardsKitsProgrammersEvaluationAndDemonstrationBoardsAndKitsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
          $this->cols = unserialize(\App\Helper::find(35)->helper);
        Schema::create('programmers__evaluation_and', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('programmers__evaluation_and');
    }
}
