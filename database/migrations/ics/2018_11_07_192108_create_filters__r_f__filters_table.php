...
class CreateFiltersRFFiltersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                $this->cols = unserialize(\App\Helper::find(67)->helper);
        Schema::create('filters__r_f__filters', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('filters__r_f__filters');
    }
}
