...
class CreateLogicGatesAndInvertersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                   $this->cols = unserialize(\App\Helper::find(125)->helper);
        Schema::create('logic__gates_and__inverters', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('logic__gates_and__inverters');
    }
}
