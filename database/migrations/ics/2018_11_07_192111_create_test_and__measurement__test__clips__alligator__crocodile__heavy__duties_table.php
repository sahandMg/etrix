...
class CreateTestAndMeasurementTestClipsAlligatorCrocodileHeavyDutiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                                 $this->cols = unserialize(\App\Helper::find(224)->helper);
        Schema::create('alligator__crocodile__heavy__duties', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('alligator__crocodile__heavy__duties');
    }
}
