...
class CreateLogicCountersDividersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(122)->helper);
        Schema::create('logic__counters__dividers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('logic__counters__dividers');
    }
}
