...
class CreateCircuitProtectionTVSThyristorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(16)->helper);
        Schema::create('circuit__protection__t_v_s__thyristors', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('circuit__protection__t_v_s__thyristors');
    }
}
