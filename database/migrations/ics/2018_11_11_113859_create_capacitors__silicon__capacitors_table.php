...
class CreateCapacitorsSiliconCapacitorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(238)->helper);
        Schema::create('capacitors__silicon__capacitors', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('capacitors__silicon__capacitors');
    }
}
