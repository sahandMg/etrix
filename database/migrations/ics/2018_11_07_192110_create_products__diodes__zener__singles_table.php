...
class CreateProductsDiodesZenerSinglesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('products__diodes__zener__singles', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('products__diodes__zener__singles');
    }
}
