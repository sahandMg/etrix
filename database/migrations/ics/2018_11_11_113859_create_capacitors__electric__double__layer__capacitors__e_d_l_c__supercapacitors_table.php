...
class CreateCapacitorsElectricDoubleLayerCapacitorsEDLCSupercapacitorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(235)->helper);
        Schema::create('capacitors__e_d_l_c__supercapacitors', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('capacitors__e_d_l_c__supercapacitors');
    }
}
