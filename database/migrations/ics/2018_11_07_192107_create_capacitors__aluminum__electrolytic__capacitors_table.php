...
class CreateCapacitorsAluminumElectrolyticCapacitorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(8)->helper);
        Schema::create('capacitors__aluminum__electrolytic__capacitors', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('capacitors__aluminum__electrolytic__capacitors');
    }
}
