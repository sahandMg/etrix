...
class CreateRFModulatorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                                           $this->cols = unserialize(\App\Helper::find(193)->helper);
        Schema::create('r_f__modulators', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('r_f__modulators');
    }
}
