...
class CreateOptoisolatorsTransistorPhotovoltaicOutputsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                       $this->cols = unserialize(\App\Helper::find(172)->helper);
        Schema::create('optoisolators__transistor__photovoltaic__outputs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('optoisolators__transistor__photovoltaic__outputs');
    }
}
