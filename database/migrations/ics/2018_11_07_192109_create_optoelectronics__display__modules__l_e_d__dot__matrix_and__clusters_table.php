...
class CreateOptoelectronicsDisplayModulesLEDDotMatrixAndClustersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                   $this->cols = unserialize(\App\Helper::find(179)->helper);
        Schema::create('l_e_d__dot__matrix_and__clusters', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('l_e_d__dot__matrix_and__clusters');
    }
}
