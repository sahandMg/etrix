...
class CreateTerminalsWireSpliceConnectorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                           $this->cols = unserialize(\App\Helper::find(32)->helper);
        Schema::create('terminals__wire__splice__connectors', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('terminals__wire__splice__connectors');
    }
}
