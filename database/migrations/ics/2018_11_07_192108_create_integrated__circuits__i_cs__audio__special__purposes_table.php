...
class CreateIntegratedCircuitsICsAudioSpecialPurposesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('integrated__circuits__i_cs__audio__special__purposes', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('integrated__circuits__i_cs__audio__special__purposes');
    }
}
