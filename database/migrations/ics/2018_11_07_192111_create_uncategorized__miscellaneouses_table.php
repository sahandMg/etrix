...
class CreateUncategorizedMiscellaneousesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(231)->helper);
        Schema::create('uncategorized__miscellaneouses', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('uncategorized__miscellaneouses');
    }
}
