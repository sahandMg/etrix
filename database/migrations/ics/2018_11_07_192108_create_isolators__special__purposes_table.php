...
class CreateIsolatorsSpecialPurposesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                     $this->cols = unserialize(\App\Helper::find(174)->helper);
        Schema::create('isolators__special__purposes', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('isolators__special__purposes');
    }
}
