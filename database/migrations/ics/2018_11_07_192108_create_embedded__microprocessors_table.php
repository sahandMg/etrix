...
class CreateEmbeddedMicroprocessorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
             $this->cols = unserialize(\App\Helper::find(91)->helper);
        Schema::create('embedded__microprocessors', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('embedded__microprocessors');
    }
}
