...
class CreateResistorsResistorNetworksArraysTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                $this->cols = unserialize(\App\Helper::find(205)->helper);
        Schema::create('resistors__resistor__networks__arrays', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('resistors__resistor__networks__arrays');
    }
}
