...
class CreatePMICBatteryManagementsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(140)->helper);
        Schema::create('p_m_i_c__battery__managements', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('p_m_i_c__battery__managements');
    }
}
