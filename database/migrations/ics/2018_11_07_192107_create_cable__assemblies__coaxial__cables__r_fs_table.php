...
class CreateCableAssembliesCoaxialCablesRFsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(3)->helper);
        Schema::create('cable__assemblies__coaxial__cables__r_fs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('cable__assemblies__coaxial__cables__r_fs');
    }
}
