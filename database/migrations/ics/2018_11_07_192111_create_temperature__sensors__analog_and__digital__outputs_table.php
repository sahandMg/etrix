...
class CreateTemperatureSensorsAnalogAndDigitalOutputsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
      $this->cols = unserialize(\App\Helper::find(218)->helper);
        Schema::create('temperature__sensors__analog_and__digital__outputs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('temperature__sensors__analog_and__digital__outputs');
    }
}
