...
class CreatePMICLEDDriversTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                            $this->cols = unserialize(\App\Helper::find(148)->helper);
        Schema::create('p_m_i_c__l_e_d__drivers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('p_m_i_c__l_e_d__drivers');
    }
}
