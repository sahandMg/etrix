...
class CreateSensorsTransducersPositionSensorsAngleLinearPositionMeasuringsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                                   $this->cols = unserialize(\App\Helper::find(215)->helper);
        Schema::create('angle__linear__position__measurings', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('angle__linear__position__measurings');
    }
}
