...
class CreateInterfaceAnalogSwitchesSpecialPurposesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                $this->cols = unserialize(\App\Helper::find(94)->helper);
        Schema::create('interface__analog__switches__special__purposes', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('interface__analog__switches__special__purposes');
    }
}
