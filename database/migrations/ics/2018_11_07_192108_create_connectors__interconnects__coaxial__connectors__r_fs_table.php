...
class CreateConnectorsInterconnectsCoaxialConnectorsRFsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(19)->helper);
        Schema::create('connectors__interconnects__coaxial__connectors__r_fs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('connectors__interconnects__coaxial__connectors__r_fs');
    }
}
