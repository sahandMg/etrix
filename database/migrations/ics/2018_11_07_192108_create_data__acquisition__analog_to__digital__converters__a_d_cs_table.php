...
class CreateDataAcquisitionAnalogToDigitalConvertersADCsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
       $this->cols = unserialize(\App\Helper::find(82)->helper);
        Schema::create('data__acquisition__analog_to__digital__converters__a_d_cs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('data__acquisition__analog_to__digital__converters__a_d_cs');
    }
}
