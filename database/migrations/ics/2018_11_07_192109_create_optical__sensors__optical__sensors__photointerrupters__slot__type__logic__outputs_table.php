...
class CreateOpticalSensorsOpticalSensorsPhotointerruptersSlotTypeLogicOutputsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                               $this->cols = unserialize(\App\Helper::find(211)->helper);
        Schema::create('sensors__slot__type__logic__outputs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('sensors__slot__type__logic__outputs');
    }
}
