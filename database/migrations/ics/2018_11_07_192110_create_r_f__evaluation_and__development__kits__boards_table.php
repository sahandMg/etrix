...
class CreateRFEvaluationAndDevelopmentKitsBoardsTable extends Migration
{
    ...
    public function up()
    {
                              $this->cols = unserialize(\App\Helper::find(190)->helper);
        Schema::create('r_f__evaluation_and__development__kits__boards', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('r_f__evaluation_and__development__kits__boards');
    }
}
