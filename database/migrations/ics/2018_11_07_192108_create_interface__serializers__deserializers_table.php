...
class CreateInterfaceSerializersDeserializersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
               $this->cols = unserialize(\App\Helper::find(106)->helper);
        Schema::create('interface__serializers__deserializers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('interface__serializers__deserializers');
    }
}
