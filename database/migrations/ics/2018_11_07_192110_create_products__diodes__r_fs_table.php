...
class CreateProductsDiodesRFsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                           $this->cols = unserialize(\App\Helper::find(42)->helper);
        Schema::create('products__diodes__r_fs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('products__diodes__r_fs');
    }
}
