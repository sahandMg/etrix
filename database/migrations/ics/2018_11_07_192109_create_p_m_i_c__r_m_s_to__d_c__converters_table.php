...
class CreatePMICRMSToDCConvertersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
               $this->cols = unserialize(\App\Helper::find(157)->helper);
        Schema::create('p_m_i_c__r_m_s_to__d_c__converters', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('p_m_i_c__r_m_s_to__d_c__converters');
    }
}
