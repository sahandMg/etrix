...
class CreateLineProtectionDistributionBackupsPowerDistributionSurgeProtectorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                          $this->cols = unserialize(\App\Helper::find(175)->helper);
        Schema::create('backups__power__distribution__surge__protectors', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('backups__power__distribution__surge__protectors');
    }
}
