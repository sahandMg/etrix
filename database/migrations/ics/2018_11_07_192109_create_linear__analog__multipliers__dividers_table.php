...
class CreateLinearAnalogMultipliersDividersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                    $this->cols = unserialize(\App\Helper::find(117)->helper);
        Schema::create('linear__analog__multipliers__dividers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('linear__analog__multipliers__dividers');
    }
}
