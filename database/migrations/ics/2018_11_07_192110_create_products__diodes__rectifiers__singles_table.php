...
class CreateProductsDiodesRectifiersSinglesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                               $this->cols = unserialize(\App\Helper::find(41)->helper);
        Schema::create('products__diodes__rectifiers__singles', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('products__diodes__rectifiers__singles');
    }
}
