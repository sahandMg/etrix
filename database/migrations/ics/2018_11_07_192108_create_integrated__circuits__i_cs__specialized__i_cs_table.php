...
class CreateIntegratedCircuitsICsSpecializedICsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
           $this->cols = unserialize(\App\Helper::find(168)->helper);
        Schema::create('integrated__circuits__i_cs__specialized__i_cs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('integrated__circuits__i_cs__specialized__i_cs');
    }
}
