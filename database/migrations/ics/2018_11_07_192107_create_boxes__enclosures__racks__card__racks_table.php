...
class CreateBoxesEnclosuresRacksCardRacksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(1)->helper);
        Schema::create('boxes__enclosures__racks__card__racks', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('boxes__enclosures__racks__card__racks');
    }
}
