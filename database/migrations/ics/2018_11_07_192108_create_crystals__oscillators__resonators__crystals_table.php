...
class CreateCrystalsOscillatorsResonatorsCrystalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(33)->helper);
        Schema::create('crystals__oscillators__resonators__crystals', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('crystals__oscillators__resonators__crystals');
    }
}
