...
class CreateCrystalsOscillatorsResonatorsOscillatorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
       $this->cols = unserialize(\App\Helper::find(34)->helper);
        Schema::create('crystals__oscillators__resonators__oscillators', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('crystals__oscillators__resonators__oscillators');
    }
}
