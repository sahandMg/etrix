...
class CreatePMICACDCConvertersOfflineSwitchersTable extends Migration
{
    ...
    public function up()
    {
                                  $this->cols = unserialize(\App\Helper::find(138)->helper);
        Schema::create('p_m_i_c__a_c__d_c__converters__offline__switchers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('p_m_i_c__a_c__d_c__converters__offline__switchers');
    }
}
