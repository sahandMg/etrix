...
class CreateToolsCrimpersApplicatorsPressesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                                             $this->cols = unserialize(\App\Helper::find(227)->helper);
        Schema::create('tools__crimpers__applicators__presses', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('tools__crimpers__applicators__presses');
    }
}
