...
class CreatePMICCurrentRegulationManagementsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
              $this->cols = unserialize(\App\Helper::find(141)->helper);
        Schema::create('p_m_i_c__current__regulation__managements', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('p_m_i_c__current__regulation__managements');
    }
}
