...
class CreateFiltersSAWFiltersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                 $this->cols = unserialize(\App\Helper::find(68)->helper);
        Schema::create('filters__s_a_w__filters', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('filters__s_a_w__filters');
    }
}
