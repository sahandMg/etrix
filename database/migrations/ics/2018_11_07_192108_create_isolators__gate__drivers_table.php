...
class CreateIsolatorsGateDriversTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                 $this->cols = unserialize(\App\Helper::find(170)->helper);
        Schema::create('isolators__gate__drivers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('isolators__gate__drivers');
    }
}
