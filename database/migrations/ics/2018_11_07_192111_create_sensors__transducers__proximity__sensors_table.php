...
class CreateSensorsTransducersProximitySensorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                                       $this->cols = unserialize(\App\Helper::find(216)->helper);
        Schema::create('sensors__transducers__proximity__sensors', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('sensors__transducers__proximity__sensors');
    }
}
