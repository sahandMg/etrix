...
class CreateOpticalSensorsOpticalSensorsAmbientLightIRUVSensorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                         $this->cols = unserialize(\App\Helper::find(209)->helper);
        Schema::create('sensors__ambient__light__i_r__u_v__sensors', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('sensors__ambient__light__i_r__u_v__sensors');
    }
}
