...
class CreateClockTimingClockBuffersDriversTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(74)->helper);
        Schema::create('clock__timing__clock__buffers__drivers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('clock__timing__clock__buffers__drivers');
    }
}
