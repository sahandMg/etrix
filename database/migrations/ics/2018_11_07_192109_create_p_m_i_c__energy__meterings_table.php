...
class CreatePMICEnergyMeteringsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                $this->cols = unserialize(\App\Helper::find(143)->helper);
        Schema::create('p_m_i_c__energy__meterings', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('p_m_i_c__energy__meterings');
    }
}
