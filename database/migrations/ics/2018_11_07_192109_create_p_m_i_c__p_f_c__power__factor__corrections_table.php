...
class CreatePMICPFCPowerFactorCorrectionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                                             $this->cols = unserialize(\App\Helper::find(152)->helper);
        Schema::create('p_m_i_c__p_f_c__power__factor__corrections', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('p_m_i_c__p_f_c__power__factor__corrections');
    }
}
