...
class CreateCapacitorsCapacitorNetworksArraysTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(234)->helper);
        Schema::create('capacitors__capacitor__networks', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('capacitors__capacitor__networks__arrays');
    }
}
