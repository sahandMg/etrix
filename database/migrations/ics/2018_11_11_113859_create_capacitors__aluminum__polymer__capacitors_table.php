...
class CreateCapacitorsAluminumPolymerCapacitorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(233)->helper);
        Schema::create('capacitors__aluminum__polymer__capacitors', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('capacitors__aluminum__polymer__capacitors');
    }
}
