...
class CreateInterfaceSignalTerminatorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
       $this->cols = unserialize(\App\Helper::find(108)->helper);
        Schema::create('interface__signal__terminators', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('interface__signal__terminators');
    }
}
