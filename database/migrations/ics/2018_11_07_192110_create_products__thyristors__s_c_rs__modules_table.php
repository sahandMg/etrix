...
class CreateProductsThyristorsSCRsModulesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                  $this->cols = unserialize(\App\Helper::find(49)->helper);
        Schema::create('products__thyristors__s_c_rs__modules', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('products__thyristors__s_c_rs__modules');
    }
}
