...
class CreateInterfaceSignalBuffersRepeatersSplittersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                    $this->cols = unserialize(\App\Helper::find(107)->helper);
        Schema::create('interface__signal__buffers__repeaters__splitters', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('interface__signal__buffers__repeaters__splitters');
    }
}
