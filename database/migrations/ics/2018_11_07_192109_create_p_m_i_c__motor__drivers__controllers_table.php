...
class CreatePMICMotorDriversControllersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                                   $this->cols = unserialize(\App\Helper::find(150)->helper);
        Schema::create('p_m_i_c__motor__drivers__controllers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('p_m_i_c__motor__drivers__controllers');
    }
}
