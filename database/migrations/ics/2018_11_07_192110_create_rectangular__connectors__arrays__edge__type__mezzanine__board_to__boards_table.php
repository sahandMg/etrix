...
class CreateRectangularConnectorsArraysEdgeTypeMezzanineBoardToBoardsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                                $this->cols = unserialize(\App\Helper::find(22)->helper);
        Schema::create('type__mezzanine__board_to__boards', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('type__mezzanine__board_to__boards');
    }
}
