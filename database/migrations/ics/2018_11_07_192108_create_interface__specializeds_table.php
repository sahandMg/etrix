...
class CreateInterfaceSpecializedsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
       $this->cols = unserialize(\App\Helper::find(109)->helper);
        Schema::create('interface__specializeds', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('interface__specializeds');
    }
}
