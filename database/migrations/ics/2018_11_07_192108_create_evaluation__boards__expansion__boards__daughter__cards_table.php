...
class CreateEvaluationBoardsExpansionBoardsDaughterCardsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
            $this->cols = unserialize(\App\Helper::find(36)->helper);
        Schema::create('evaluation__boards__expansion__boards__daughter__cards', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('evaluation__boards__expansion__boards__daughter__cards');
    }
}
