...
class CreateCapacitorsThinFilmCapacitorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(241)->helper);
        Schema::create('capacitors__thin__film__capacitors', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('capacitors__thin__film__capacitors');
    }
}
