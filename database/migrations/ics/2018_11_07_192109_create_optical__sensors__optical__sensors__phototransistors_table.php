...
class CreateOpticalSensorsOpticalSensorsPhototransistorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
             $this->cols = unserialize(\App\Helper::find(213)->helper);
        Schema::create('optical__sensors__optical__sensors__phototransistors', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('optical__sensors__optical__sensors__phototransistors');
    }
}
