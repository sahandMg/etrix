...
class CreateLinearComparatorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
$this->cols = unserialize(\App\Helper::find(118)->helper);
        Schema::create('linear__comparators', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('linear__comparators');
    }
}
