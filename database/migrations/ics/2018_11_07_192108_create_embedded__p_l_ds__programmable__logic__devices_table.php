...
class CreateEmbeddedPLDsProgrammableLogicDevicesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
         $this->cols = unserialize(\App\Helper::find(92)->helper);
        Schema::create('embedded__p_l_ds__programmable__logic__devices', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('embedded__p_l_ds__programmable__logic__devices');
    }
}
