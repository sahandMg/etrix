...
class CreateSensorsTransducersDustSensorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                         $this->cols = unserialize(\App\Helper::find(207)->helper);
        Schema::create('sensors__transducers__dust__sensors', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('sensors__transducers__dust__sensors');
    }
}
