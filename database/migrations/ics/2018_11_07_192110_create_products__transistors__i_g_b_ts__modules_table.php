...
class CreateProductsTransistorsIGBTsModulesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                             $this->cols = unserialize(\App\Helper::find(59)->helper);
        Schema::create('products__transistors__i_g_b_ts__modules', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('products__transistors__i_g_b_ts__modules');
    }
}
