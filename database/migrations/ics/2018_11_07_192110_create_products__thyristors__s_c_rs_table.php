...
class CreateProductsThyristorsSCRsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                    $this->cols = unserialize(\App\Helper::find(48)->helper);
        Schema::create('products__thyristors__s_c_rs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('products__thyristors__s_c_rs');
    }
}
