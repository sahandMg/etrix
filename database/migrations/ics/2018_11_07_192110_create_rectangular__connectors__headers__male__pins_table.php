...
class CreateRectangularConnectorsHeadersMalePinsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                                       $this->cols = unserialize(\App\Helper::find(24)->helper);
        Schema::create('rectangular__connectors__headers__male__pins', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('rectangular__connectors__headers__male__pins');
    }
}
