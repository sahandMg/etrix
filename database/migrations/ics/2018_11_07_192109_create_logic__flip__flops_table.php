...
class CreateLogicFlipFlopsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
             $this->cols = unserialize(\App\Helper::find(124)->helper);
        Schema::create('logic__flip__flops', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('logic__flip__flops');
    }
}
