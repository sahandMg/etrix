...
class CreateProductsTransistorsBipolarBJTSinglesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
            $this->cols = unserialize(\App\Helper::find(54)->helper);
        Schema::create('products__transistors__bipolar__b_j_t__singles', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('products__transistors__bipolar__b_j_t__singles');
    }
}
