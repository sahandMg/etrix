...
class CreateLogicComparatorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
       $this->cols = unserialize(\App\Helper::find(121)->helper);
        Schema::create('logic__comparators', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('logic__comparators');
    }
}
