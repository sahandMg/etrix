...
class CreateCircuitProtectionTVSMixedTechnologiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(15)->helper);
        Schema::create('circuit__protection__t_v_s__mixed__technologies', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('circuit__protection__t_v_s__mixed__technologies');
    }
}
