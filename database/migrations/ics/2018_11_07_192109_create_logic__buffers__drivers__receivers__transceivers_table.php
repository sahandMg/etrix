...
class CreateLogicBuffersDriversReceiversTransceiversTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
      $this->cols = unserialize(\App\Helper::find(120)->helper);
        Schema::create('logic__buffers__drivers__receivers__transceivers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('logic__buffers__drivers__receivers__transceivers');
    }
}
