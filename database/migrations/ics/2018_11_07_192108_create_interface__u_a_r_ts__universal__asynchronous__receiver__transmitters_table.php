...
class CreateInterfaceUARTsUniversalAsynchronousReceiverTransmittersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
             $this->cols = unserialize(\App\Helper::find(111)->helper);
        Schema::create('asynchronous__receiver__transmitters', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('asynchronous__receiver__transmitters');
    }
}
