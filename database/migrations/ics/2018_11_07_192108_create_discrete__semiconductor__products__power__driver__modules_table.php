...
class CreateDiscreteSemiconductorProductsPowerDriverModulesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
            $this->cols = unserialize(\App\Helper::find(46)->helper);
        Schema::create('discrete__semiconductor__products__power__driver__modules', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('discrete__semiconductor__products__power__driver__modules');
    }
}
