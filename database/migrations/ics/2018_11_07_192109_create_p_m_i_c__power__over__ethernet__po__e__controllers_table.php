...
class CreatePMICPowerOverEthernetPoEControllersTable extends Migration
{
    ...
    public function up()
    {
           $this->cols = unserialize(\App\Helper::find(155)->helper);
        Schema::create('p_m_i_c__power__over__ethernet__po__e__controllers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('p_m_i_c__power__over__ethernet__po__e__controllers');
    }
}
