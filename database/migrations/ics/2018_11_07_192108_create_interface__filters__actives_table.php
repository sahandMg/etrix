...
class CreateInterfaceFiltersActivesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                 $this->cols = unserialize(\App\Helper::find(101)->helper);
        Schema::create('interface__filters__actives', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('interface__filters__actives');
    }
}
