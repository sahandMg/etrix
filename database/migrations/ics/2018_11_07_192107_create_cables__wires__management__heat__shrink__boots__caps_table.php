...
class CreateCablesWiresManagementHeatShrinkBootsCapsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(5)->helper);
        Schema::create('cables__wires__management__heat__shrink__boots__caps', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('cables__wires__management__heat__shrink__boots__caps');
    }
}
