...
class CreateLogicTranslatorsLevelShiftersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(133)->helper);
        Schema::create('logic__translators__level__shifters', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('logic__translators__level__shifters');
    }
}
