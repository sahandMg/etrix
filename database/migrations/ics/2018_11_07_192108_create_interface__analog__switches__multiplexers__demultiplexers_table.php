...
class CreateInterfaceAnalogSwitchesMultiplexersDemultiplexersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
               $this->cols = unserialize(\App\Helper::find(95)->helper);
        Schema::create('interface__analog__switches__multiplexers__demultiplexers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('interface__analog__switches__multiplexers__demultiplexers');
    }
}
