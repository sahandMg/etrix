...
class CreateFiltersEMIRFIFiltersLCRCNetworksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
              $this->cols = unserialize(\App\Helper::find(66)->helper);
        Schema::create('filters__e_m_i__r_f_i__filters__l_c__r_c__networks', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('filters__e_m_i__r_f_i__filters__l_c__r_c__networks');
    }
}
