...
class CreateTerminalBlocksBarrierBlocksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
            $this->cols = unserialize(\App\Helper::find(27)->helper);
        Schema::create('terminal__blocks__barrier__blocks', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('terminal__blocks__barrier__blocks');
    }
}
