...
class CreatePMICORControllersIdealDiodesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                                       $this->cols = unserialize(\App\Helper::find(151)->helper);
        Schema::create('p_m_i_c__o_r__controllers__ideal__diodes', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('p_m_i_c__o_r__controllers__ideal__diodes');
    }
}
