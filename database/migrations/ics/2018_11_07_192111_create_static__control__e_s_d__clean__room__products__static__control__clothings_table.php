...
class CreateStaticControlESDCleanRoomProductsStaticControlClothingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                                            $this->cols = unserialize(\App\Helper::find(220)->helper);
        Schema::create('products__static__control__clothings', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('products__static__control__clothings');
    }
}
