...
class CreatePMICPowerSupplyControllersMonitorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
              $this->cols = unserialize(\App\Helper::find(156)->helper);
        Schema::create('p_m_i_c__power__supply__controllers__monitors', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('p_m_i_c__power__supply__controllers__monitors');
    }
}
