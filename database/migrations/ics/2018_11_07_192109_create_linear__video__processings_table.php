...
class CreateLinearVideoProcessingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
      $this->cols = unserialize(\App\Helper::find(119)->helper);
        Schema::create('linear__video__processings', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('linear__video__processings');
    }
}
