...
class CreateToolsTweezersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(230)->helper);
        Schema::create('tools__tweezers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('tools__tweezers');
    }
}
