...
class CreatePMICPowerManagementSpecializedsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(154)->helper);
        Schema::create('p_m_i_c__power__management__specializeds', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('p_m_i_c__power__management__specializeds');
    }
}
