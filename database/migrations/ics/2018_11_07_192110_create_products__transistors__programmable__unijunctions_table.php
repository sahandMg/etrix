...
class CreateProductsTransistorsProgrammableUnijunctionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
               $this->cols = unserialize(\App\Helper::find(62)->helper);
        Schema::create('products__transistors__programmable__unijunctions', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('products__transistors__programmable__unijunctions');
    }
}
