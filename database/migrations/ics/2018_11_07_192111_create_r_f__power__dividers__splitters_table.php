...
class CreateRFPowerDividersSplittersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                                               $this->cols = unserialize(\App\Helper::find(194)->helper);
        Schema::create('r_f__power__dividers__splitters', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('r_f__power__dividers__splitters');
    }
}
