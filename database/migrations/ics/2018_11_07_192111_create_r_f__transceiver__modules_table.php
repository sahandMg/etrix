...
class CreateRFTransceiverModulesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                   $this->cols = unserialize(\App\Helper::find(198)->helper);
        Schema::create('r_f__transceiver__modules', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('r_f__transceiver__modules');
    }
}
