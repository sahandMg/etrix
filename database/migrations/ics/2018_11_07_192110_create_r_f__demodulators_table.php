...
class CreateRFDemodulatorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                     $this->cols = unserialize(\App\Helper::find(188)->helper);
        Schema::create('r_f__demodulators', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('r_f__demodulators');
    }
}
