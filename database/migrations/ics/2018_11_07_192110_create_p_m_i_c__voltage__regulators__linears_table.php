...
class CreatePMICVoltageRegulatorsLinearsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
          $this->cols = unserialize(\App\Helper::find(164)->helper);
        Schema::create('p_m_i_c__voltage__regulators__linears', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('p_m_i_c__voltage__regulators__linears');
    }
}
