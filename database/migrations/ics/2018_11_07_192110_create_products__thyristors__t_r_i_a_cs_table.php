...
class CreateProductsThyristorsTRIACsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                       $this->cols = unserialize(\App\Helper::find(50)->helper);
        Schema::create('products__thyristors__t_r_i_a_cs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('products__thyristors__t_r_i_a_cs');
    }
}
