...
class CreateToolsInsertionExtractionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
         $this->cols = unserialize(\App\Helper::find(228)->helper);
        Schema::create('tools__insertion__extractions', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('tools__insertion__extractions');
    }
}
