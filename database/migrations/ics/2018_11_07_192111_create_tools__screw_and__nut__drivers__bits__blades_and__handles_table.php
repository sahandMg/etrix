...
class CreateToolsScrewAndNutDriversBitsBladesAndHandlesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
       $this->cols = unserialize(\App\Helper::find(229)->helper);
        Schema::create('tools__screw_and__nut__drivers__bits__blades_and__handles', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('tools__screw_and__nut__drivers__bits__blades_and__handles');
    }
}
