...
class CreateDataAcquisitionDigitalToAnalogConvertersDACsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(84)->helper);
        Schema::create('data__acquisition__digital_to__analog__converters__d_a_cs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('data__acquisition__digital_to__analog__converters__d_a_cs');
    }
}
