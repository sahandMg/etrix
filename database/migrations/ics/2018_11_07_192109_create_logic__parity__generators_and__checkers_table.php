...
class CreateLogicParityGeneratorsAndCheckersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                             $this->cols = unserialize(\App\Helper::find(129)->helper);
        Schema::create('logic__parity__generators_and__checkers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('logic__parity__generators_and__checkers');
    }
}
