...
class CreateInterfaceIOExpandersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                   $this->cols = unserialize(\App\Helper::find(102)->helper);
        Schema::create('interface__i__o__expanders', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('interface__i__o__expanders');
    }
}
