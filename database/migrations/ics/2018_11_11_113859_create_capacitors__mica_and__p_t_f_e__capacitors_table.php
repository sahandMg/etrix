...
class CreateCapacitorsMicaAndPTFECapacitorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(236)->helper);
        Schema::create('capacitors__mica_and__p_t_f_e__capacitors', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('capacitors__mica_and__p_t_f_e__capacitors');
    }
}
