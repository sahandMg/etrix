...
class CreateInterfaceEncodersDecodersConvertersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                $this->cols = unserialize(\App\Helper::find(100)->helper);
        Schema::create('interface__encoders__decoders__converters', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('interface__encoders__decoders__converters');
    }
}
