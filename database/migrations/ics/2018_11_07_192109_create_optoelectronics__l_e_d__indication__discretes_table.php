...
class CreateOptoelectronicsLEDIndicationDiscretesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                      $this->cols = unserialize(\App\Helper::find(180)->helper);
        Schema::create('optoelectronics__l_e_d__indication__discretes', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('optoelectronics__l_e_d__indication__discretes');
    }
}
