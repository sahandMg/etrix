...
class CreateEmbeddedSystemOnChipSoCsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('embedded__system__on__chip__so__cs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('embedded__system__on__chip__so__cs');
    }
}
