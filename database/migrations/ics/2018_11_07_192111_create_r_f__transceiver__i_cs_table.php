...
class CreateRFTransceiverICsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
             $this->cols = unserialize(\App\Helper::find(197)->helper);
        Schema::create('r_f__transceiver__i_cs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('r_f__transceiver__i_cs');
    }
}
