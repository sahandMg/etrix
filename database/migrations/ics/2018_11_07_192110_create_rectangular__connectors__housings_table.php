...
class CreateRectangularConnectorsHousingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->cols = unserialize(\App\Helper::find(26)->helper);
        Schema::create('rectangular__connectors__housings', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('rectangular__connectors__housings');
    }
}
