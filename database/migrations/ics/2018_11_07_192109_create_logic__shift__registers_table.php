...
class CreateLogicShiftRegistersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                               $this->cols = unserialize(\App\Helper::find(130)->helper);
        Schema::create('logic__shift__registers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('logic__shift__registers');
    }
}
