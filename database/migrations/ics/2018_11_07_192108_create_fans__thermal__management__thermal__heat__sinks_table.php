...
class CreateFansThermalManagementThermalHeatSinksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                 $this->cols = unserialize(\App\Helper::find(64)->helper);
        Schema::create('fans__thermal__management__thermal__heat__sinks', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('fans__thermal__management__thermal__heat__sinks');
    }
}
