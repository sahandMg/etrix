...
class CreateInterfaceModemsICsAndModulesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                     $this->cols = unserialize(\App\Helper::find(103)->helper);
        Schema::create('interface__modems__i_cs_and__modules', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('interface__modems__i_cs_and__modules');
    }
}
