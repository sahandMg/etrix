...
class CreateSwitchesSlideSwitchesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                       $this->cols = unserialize(\App\Helper::find(221)->helper);
        Schema::create('switches__slide__switches', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('switches__slide__switches');
    }
}
