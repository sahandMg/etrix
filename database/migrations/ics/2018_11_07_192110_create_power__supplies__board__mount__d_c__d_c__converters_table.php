...
class CreatePowerSuppliesBoardMountDCDCConvertersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                    $this->cols = unserialize(\App\Helper::find(183)->helper);
        Schema::create('mount__board__d_c__d_c__converters', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('mount__board__d_c__d_c__converters');
    }
}
