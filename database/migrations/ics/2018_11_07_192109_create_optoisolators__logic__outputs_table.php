...
class CreateOptoisolatorsLogicOutputsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
                      $this->cols = unserialize(\App\Helper::find(171)->helper);
        Schema::create('optoisolators__logic__outputs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('optoisolators__logic__outputs');
    }
}
