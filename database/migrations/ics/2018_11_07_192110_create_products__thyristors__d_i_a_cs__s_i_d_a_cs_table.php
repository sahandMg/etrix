...
class CreateProductsThyristorsDIACsSIDACsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
              $this->cols = unserialize(\App\Helper::find(47)->helper);
        Schema::create('products__thyristors__d_i_a_cs__s_i_d_a_cs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('products__thyristors__d_i_a_cs__s_i_d_a_cs');
    }
}
