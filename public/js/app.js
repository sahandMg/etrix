...
var _queryString = __webpack_require__(817);
...
var showSearchProductResult = function (_Component) {
    ...
    function showSearchProductResult() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = showSearchProductResult.__proto__ || Object.getPrototypeOf(showSearchProductResult)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            ...
            // }).join('&')
            var stringified = _queryString2.default.stringify(filters, { arrayFormat: 'bracket' });

            console.log(stringified);
            console.log("filterComponent new packages parse");
            console.log(_queryString2.default.parse(stringified));
            var url = '/search/' + _this.state.category.name + '/' + _this.props.match.params.keyword + '/' + stringified;
            // url = url.replace('{',"%7B");
            // url = url.replace('}',"%7D");
