...
<head>
    ...
    <meta name="description" content="فروشگاه آنلاین قطعات الکترونیک و مجله آموزشی الکترونیک" />
        ...
        ! function(i) {
            ...
            d.e = function(l) {
                ...
                if (d.r(r), Object.defineProperty(r, "default", {
                    ...
                    for (var n in t) d.d(r, n, function(e) {
                        return t[e]
                    }.bind(null, n));
                return r
            }, d.n = function(e) {
            ...
            $('.iconbar-container').click(function() {
                ...
                $(".navbar-sticky-bg").fadeIn('slow', function() {
                    ...
                    $('.navbar-sticky').animate({
                        'left': $(window).outerWidth() - $(".navbar-sticky").outerWidth()
                    }, 'fast')
                })
            });
